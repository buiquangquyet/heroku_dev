...
$pf_slug_name = get_theme_mod('pf_slug_name') ? get_theme_mod('pf_slug_name') :'portfolio';
$pf_category_slug_name = get_theme_mod('pf_category_slug_name') ? get_theme_mod('pf_category_slug_name') : 'portfolio-category';
...
function portfolio_register() {
	...
	$labels = array(
		...
		'edit_item'		=> __('Edit Post', 'innova', 'innova'),
		'new_item'		=> __('New Post Item ', 'innova', 'innova'),
		'view_item'		=> __('View Post Item ', 'innova', 'innova'),
		'search_items'	=> __('Search ', 'innova') . ucwords($pf_slug_name) . _x(' Items', 'innova','innova'),
		'not_found'		=> __('Nothing found', 'innova', 'innova'),
		'not_found_in_trash'	=> __('not_found_in_trash', 'innova'),
		'parent_item_colon'	=> ''
	);
	...
	$args = array(
		...
		'hierarchical'		=> false,
		'rewrite' => array( 'slug' => strtolower($pf_slug_name), 
		'with_front' => false ),
		'query_var'			=> false,	
