<?php
$innova_custom_options = array(
    'image_custom_description' => array(
        'label'       => __('Custom Description', 'innova'),
        'input'       => 'textarea',
        'helps'       => __('', 'innova'),
        'application' => 'image',
        'exclusions'  => array('audio', 'video'),
        'required'    => false,
        //'error_text'  => __('Copyright field required', 'innova')
    ),
    'image_custom_link' => array(
        'label'       => __('Custom link', 'innova'),
        'input'       => 'text',
        'helps'       => __('Ex:http://www.google.com', 'innova'),
        'application' => 'image',
        'exclusions'  => array('audio', 'video'),
        'required'    => false,
        //'error_text'  => __('Copyright field required', 'innova')
    ...
    'link_new_window' => array(
        'label'       => __('Target', 'innova'),
        'input'       => 'select',
        'options' => array(
            '_blank' => __('_blank','innova'),
            '_self' => __('_self','innova')
        ),
        'application' => 'image',
        'exclusions'   => array('audio', 'video')
    )
);
Class Innova_Custom_Media_Options {
...
$innova_media_custom_options = new Innova_Custom_Media_Options( $innova_custom_options );
?>